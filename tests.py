...
class TestEmail:
    ...
    def test_email_sem_dominio(self):
        email = 'mauriciocalheiro95@'
        v = val.Validador()
        assert v.validar_email(email)[0] is False

    def test_email_valido(self):
        email = 'mauriciocalheiro95@gmail.com'
        v = val.Validador()
        assert v.validar_email(email)[0] is True
...
class TestCPF:
    ...
    def test_cpf_correto(self):
        cpf = '011.931.542-43'
        v = val.Validador()
        assert v.validar_cpf(cpf)[0] is True
